...
class Compressor:
    ...
    def _build_merge_prompt(self, ai_name: str, new_text: str, existing: List[Memory], prefer_new: bool) -> List[dict]:
        ...
        sys = (
            ...
            "  • Never generalize or invent facts. Do not merge across different topics.\n"
            "\n"
            "DELETION POLICY (RARE):\n"
            "  • Only mark an existing id for deletion if it is made irrelevant and/or falsified by the NEW memory after merging.\n"
